...
typedef struct struct_test_stats {
  /* you can add variables for keeping statistics when evaluating the
	...
	long correct;	/* total number correct predictions of all classes */
  	long incorrect;	/* total number of incorrect predictions of all classes */

  	double runtime; /* Runtime (without IO) in cpu-seconds */

	int num_classes; /* total number of classes */

	long* class_corrects;	/* total number of correct predictions of each classes */
	long* class_incorrects;	/* total number of incorrect predictions of each classes */
	long* class_misses;	/* total number of incorrect predictions which mistake other classes as this class */
} STRUCT_TEST_STATS;
